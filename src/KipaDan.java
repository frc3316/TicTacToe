...
public class KipaDan extends Player
{
	...
	{	
		...
		else if (board.arr[0][0]== enemySymbol && board.arr[0][0]==EMPTY)
		{
			return new BoardMove(0 ,1 ,symbol);
		}
		
		else if (board.arr[0][1]== enemySymbol && board.arr[0][0]==EMPTY)
		{
			return new BoardMove(0 ,2 ,symbol);
		}
		
		else if (board.arr[0][2]== enemySymbol && board.arr[0][0]==EMPTY)
		{
			return new BoardMove(1 ,2 ,symbol );
		}
		
		else if (board.arr[1][2]== enemySymbol && board.arr[0][0]==EMPTY)
		{
			return new BoardMove(2 ,2 ,symbol);
		}
		
		else if (board.arr[2][2]== enemySymbol && board.arr[0][0]==EMPTY)
		{
			return new BoardMove(2 ,1 ,symbol);
		}

		else if (board.arr[2][1]== enemySymbol && board.arr[0][0]==EMPTY)
		{
			return new BoardMove(2 ,0 ,symbol);
		}

		else if (board.arr[2][0]== enemySymbol && board.arr[0][0]==EMPTY)
		{
